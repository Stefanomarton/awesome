...
gears.wallpaper.maximized("~/Pictures/sfondo2.png")
...
local term_scratch = bling.module.scratchpad {
    ...
    geometry = {x=520, y=90, height=900, width=900}, -- The geometry in a floating state
...
awful.screen.connect_for_each_screen(function(s)
    ...
    -- Create the wibox
    s.mywibox = awful.wibar({ position = "top", screen = s, bg="#1d2021", height=20,})
...
globalkeys = gears.table.join(
    ...
    awful.key({ },"XF86AudioRaiseVolume", function() awful.spawn.with_shell ("pactl -- set-sink-volume 0 +10%") end), 
    awful.key({ },"XF86AudioLowerVolume", function() awful.spawn.with_shell ("pactl -- set-sink-volume 0 -10%") end), 
...
awful.key({ modkey,           }, "j",
	...
	awful.util.spawn("rofi -show drun -theme ~/.config/rofi/themes/gruvbox/gruvbox.rasi") end,
